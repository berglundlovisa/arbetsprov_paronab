...
class JPlattaFrankfurtView extends StatefulWidget {
  const JPlattaFrankfurtView({Key? key}) : super(key: key);

  @override
  _JPlattaFrankfurtViewState createState() => _JPlattaFrankfurtViewState();
}
...
//texteditingcontroller för textfältet
  ...
  void _addJPlattaQuantity() async {
    ...
    if (docSnapshot.exists) {
      ...
      var jplattasavedquantity = data['jPlattaFrankfurtQuantity'];
...
//UPPDATERA LAGERSALDO
  void _updateJPlattaQuantity() {
    ...
    FirebaseFirestore.instance
        .collection('jPlatta')
        .doc('jPlattaID')
        .update({'jPlattaFrankfurtQuantity': jPlattaQuantity})
