...
class JPlattaNorrkopingView extends StatefulWidget {
  const JPlattaNorrkopingView({Key? key}) : super(key: key);

  @override
  _JPlattaNorrkopingViewState createState() => _JPlattaNorrkopingViewState();
}

class _JPlattaNorrkopingViewState extends State<JPlattaNorrkopingView> {
  ...
  void _addJPlattaQuantity() async {
    ...
    if (docSnapshot.exists) {
      ...
      var jplattasavedquantity = data['jPlattaNorrkopingQuantity'];
  ...
  void _updateJPlattaQuantity() {
    ...
    FirebaseFirestore.instance
        .collection('jPlatta')
        .doc('jPlattaID')
        .update({'jPlattaNorrkopingQuantity': jPlattaQuantity})
