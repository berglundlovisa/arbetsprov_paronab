...
class JTelefonNorrkopingView extends StatefulWidget {
  const JTelefonNorrkopingView({Key? key}) : super(key: key);

  @override
  _JTelefonNorrkopingViewState createState() => _JTelefonNorrkopingViewState();
}

class _JTelefonNorrkopingViewState extends State<JTelefonNorrkopingView> {
...
//texteditingcontroller för textfältet
  ...
  void _addJTelefonQuantity() async {
    ...
    if (docSnapshot.exists) {
      ...
      var jtelefonsavedquantity = data['jTelefonNorrkopingQuantity'];
...
//UPPDATERA LAGERSALDO
  void _updateJTelefonQuantity() {
    ...
    FirebaseFirestore.instance
        .collection('jTelefon')
        .doc('jTelefonID')
        .update({'jTelefonNorrkopingQuantity': jTelefonQuantity})
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Container(height: 10),
            const Text('Norrköping warehouse'),
            Container(height: 20),
            editJTelefonField(),
            Row(
