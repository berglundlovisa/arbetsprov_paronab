...
class ParonklockaNorrkopingView extends StatefulWidget {
  const ParonklockaNorrkopingView({Key? key}) : super(key: key);

  @override
  _ParonklockaNorrkopingViewState createState() =>
      _ParonklockaNorrkopingViewState();
}
...
//texteditingcontroller för textfältet
  ...
  void _addParonklockaQuantity() async {
    ...
    if (docSnapshot.exists) {
      ...
      var paronklockasavedquantity = data['paronklockaNorrkopingQuantity'];
...
//UPPDATERA LAGERSALDO
  void _updateParonklockaQuantity() {
    ...
    FirebaseFirestore.instance
        ...
        .doc('paronklockaID')
        .update({'paronklockaNorrkopingQuantity': paronklockaQuantity})
